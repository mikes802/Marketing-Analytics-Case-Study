...
The commented-out lines in some of these queries is my checking the tables to make sure I'm getting the information I want. For example, I shouldn't see the first five movies in the commented-out line below come back in the table for `customer_id` = 1, but I should see the last movie. 
```
